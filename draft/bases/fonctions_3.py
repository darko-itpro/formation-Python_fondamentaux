...
"""
    ...
    #. Ecrire une fonction qui affiche une table de multiplication de la valeur
       passée en paramètre sous la forme suivante (pour la table de 4). La
       manière la plus simple d'afficher des données sous cette forme est dans
       un paramètre de la fonction print(). Il ne vous a pas été présenté, mais
       vous devez être capable de le retrouver.
